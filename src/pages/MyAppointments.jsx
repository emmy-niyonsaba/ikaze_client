...
import {statusOptions,collegeOptions,dateOptions,
  calculateDuration,formatTime,formatDateTime,getCollegeName,getPriorityColor,
  getStatusColor
} from "../utils/constants"

import { useNavigate } from 'react-router-dom';
import { PDFDownloadLink } from '@react-pdf/renderer';
import AppointmentPDF from '../pdf/AppointmentPDF'; // Import the component above
...
const MyAppointments = () => {
  ...
  const handleReschedule = (appointmentId) => {
    ...
    // In real app: navigate(`/booking?reschedule=${appointmentId}`);
  };

  const handleDownload = (appointment) => {
    // Generate and download appointment confirmation
    console.log('Download appointment:', appointment.referenceNumber);
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [searchTerm, statusFilter, collegeFilter, dateFilter]);
        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="subtitle mt-2">Manage and track all your scheduled appointments</p>
            </div>

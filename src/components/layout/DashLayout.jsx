...
const DashboardLayout = () => {
  ...
  const getNavigationItems = () => {
    ...
    const roleSpecificItems = {
      ...
      COLLEGE_ADMIN: [
        ...
        // { path: "security-manager", icon: ShieldAlert, label: "Security" },
      ...
      DEPARTMENT_MANAGER: [
        ...
        { path: "department-schedule", icon: Calendar, label: "Schedule" },
        { path: "department-settings", icon: Settings, label: "Settings" },
      ],
      SECURITY_MANAGER: [
        ...baseItems,
  ...
  const getHeaderTitle = () => {
    const titles = {
      ...
      COLLEGE_ADMIN: `${user?.managedCollege?.name || "College"} Admin Portal`,
        ...
        <div className="p-6 border-b border-gray-100">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-blue-800 rounded-lg flex items-center justify-center">
              ...
              {user?.role === 'COLLEGE_ADMIN' && <Building2 className="w-6 h-6 text-white" />}
          ...
          <div className="grid grid-cols-2 gap-2">
            {quickActions.slice(0, 2).map((action, idx) => (
              <button
                ...
                className="flex flex-col items-center p-2 bg-white border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-colors"
              >
          ...
          <div className="flex items-center gap-4">
            ...
            <form onSubmit={handleSearch} className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 w-64 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
              />
            </form>
        ...
        <header className="lg:hidden bg-gradient-to-r from-blue-600 to-blue-800 text-white p-4 sticky top-0 z-50 flex justify-between items-center shadow-lg">
          <div className="flex items-center gap-3">
            ...
            >
              ...
              {user?.role === 'COLLEGE_ADMIN' && <Building2 className="w-5 h-5" />}
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
                  ...
                  <p className="text-gray-600 mt-1">
                    Welcome to your {user?.role?.replace('_', ' ').toLowerCase()} dashboard
                    {user?.managedCollege && ` • ${user.managedCollege.name}`}
                  </p>
                </div>
                ...
                <div className="hidden lg:flex gap-3">
                  {quickActions.slice(0, 3).map((action, idx) => (
                    <button
                      key={idx}
                      onClick={() => navigate(action.path)}
                      className={`${action.color} text-white px-4 py-2.5 rounded-lg flex items-center gap-2 text-sm font-medium hover:opacity-90 transition-opacity`}
                    >
